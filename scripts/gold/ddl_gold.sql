...
-- ============================================================================
-- Creates the central sales fact table by linking sales transactions
...
SELECT
    sd.sls_ord_num  AS order_number,         -- Order Information
...
LEFT JOIN gold.dim_products pr      -- Link to Product Dimension
    ON sd.sls_prd_key = pr.product_number

LEFT JOIN gold.dim_customers cu     -- Link to Customer Dimension
